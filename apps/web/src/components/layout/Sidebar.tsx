    ...
    <>
      ...
      >
        ...
        <div className="flex items-center gap-3 px-6 py-5 border-b border-gray-100">
          ...
          <div>
            <h1 className="text-base font-bold text-gray-900">Dispara</h1>
        ...
        <nav className="flex-1 px-3 py-4 space-y-1" aria-label="Menu principal">
          {NAV_ITEMS.map((item) => {
            ...
            return (
              <Link
                key={item.href}
                href={(item as { comingSoon?: boolean }).comingSoon ? '#' : item.href}
                onClick={() => setMobileOpen(false)}
                className={`
        ...
        <div className="px-4 py-4 border-t border-gray-100">
          <div className="flex items-center gap-3">
            <div className="w-8 h-8 rounded-full bg-indigo-100 flex items-center justify-center">
              <span className="text-xs font-bold text-indigo-600">DT</span>
            </div>
            <div className="min-w-0">
              <p className="text-sm font-medium text-gray-900 truncate">Dev Tenant</p>
